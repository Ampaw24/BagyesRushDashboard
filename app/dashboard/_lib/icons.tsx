...
export function RidersIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      <circle cx="6" cy="18" r="3" />
      <circle cx="18" cy="18" r="3" />
      <path d="M6 18 9 10h3l2 3h4" />
      <path d="M9 10 8 6h3" />
    </svg>
  );
}
...
export function UsersIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      ...
      <path d="M15 13.2a5.5 5.5 0 0 1 5.5 5.5" />
    </svg>
  );
}
...
export function SupportIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      ...
      <path d="M9 10.5a2.5 2.5 0 0 1 5 0c0 1.5-2 1.75-2 3.25" strokeWidth={1.6} />
...
export function SettingsIcon({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      ...
      <path d="M19.4 13.5a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1.04 1.56V19.5a2 2 0 1 1-4 0v-.09a1.7 1.7 0 0 0-1.04-1.56 1.7 1.7 0 0 0-1.87.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.7 1.7 0 0 0 .34-1.87 1.7 1.7 0 0 0-1.56-1.04H4.5a2 2 0 1 1 0-4h.09a1.7 1.7 0 0 0 1.56-1.04 1.7 1.7 0 0 0-.34-1.87l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.7 1.7 0 0 0 1.87.34H10.6a1.7 1.7 0 0 0 1.04-1.56V4.5a2 2 0 1 1 4 0v.09a1.7 1.7 0 0 0 1.04 1.56 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.34 1.87v.1a1.7 1.7 0 0 0 1.56 1.04h.09a2 2 0 1 1 0 4h-.09a1.7 1.7 0 0 0-1.56 1.04Z" />
    </svg>
  );
}
